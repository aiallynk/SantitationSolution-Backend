...
const Tenant = sequelize.define(
  'Tenant',
  {
    ...
    ai_scoring_mode: { type: DataTypes.STRING(16), allowNull: false, defaultValue: 'medium' },
    metadata: { type: DataTypes.JSONB, allowNull: true },
    external_api_sharing_enabled: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false },
    ...commonTimestamps,
  },
...
const Inspection = sequelize.define(
  'Inspection',
  {
    ...
    ai_scoring_mode_applied: { type: DataTypes.STRING(16), allowNull: true },
    ai_scoring_policy_version: { type: DataTypes.STRING(80), allowNull: true },
    // V2 scoring/capture snapshots are additive. Legacy rows deliberately stay null.
...
const AiAnalysisResult = sequelize.define(
  'AiAnalysisResult',
  {
    ...
    ai_scoring_mode_applied: { type: DataTypes.STRING(16), allowNull: true },
    ai_scoring_policy_version: { type: DataTypes.STRING(80), allowNull: true },
    ai_base_score: { type: DataTypes.DECIMAL(6, 2), allowNull: true },
    ai_final_score: { type: DataTypes.DECIMAL(6, 2), allowNull: true },
    ai_severity_summary: { type: DataTypes.JSONB, allowNull: true },
    scoring_mode: { type: DataTypes.STRING(16), allowNull: true },
    scoring_config_version: { type: DataTypes.STRING(80), allowNull: true },
    scoring_formula_version: { type: DataTypes.STRING(80), allowNull: true },
...
const SensorReading = sequelize.define(
  'SensorReading',
  {
    ...
    ppm: { type: DataTypes.DECIMAL(10, 2), allowNull: true },
...
const ApiUsageLog = sequelize.define(
  'ApiUsageLog',
  {
    ...
    cleanliness_min: { type: DataTypes.DECIMAL(5, 2), allowNull: true },
    include_closed: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false },
    eligible_tenant_count: { type: DataTypes.INTEGER, allowNull: true },
    candidate_toilet_count: { type: DataTypes.INTEGER, allowNull: true },
    returned_count: { type: DataTypes.INTEGER, allowNull: true },
    dropped_missing_coordinates_count: { type: DataTypes.INTEGER, allowNull: true },
    dropped_invalid_coordinates_count: { type: DataTypes.INTEGER, allowNull: true },
    dropped_tenant_sharing_count: { type: DataTypes.INTEGER, allowNull: true },
    dropped_api_scope_count: { type: DataTypes.INTEGER, allowNull: true },
    dropped_public_visibility_count: { type: DataTypes.INTEGER, allowNull: true },
    dropped_status_count: { type: DataTypes.INTEGER, allowNull: true },
    dropped_cleanliness_count: { type: DataTypes.INTEGER, allowNull: true },
