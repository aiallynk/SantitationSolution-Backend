...
const { protect, requireRoles, requireApprovalAccess } = require('../../core/middleware/auth');
...
router.post('/tenants', requireApprovalAccess(), validate(validateTenantProvision), superAdminController.postTenantProvision);
router.patch('/tenants/:id', requireApprovalAccess(), validate(validateTenantPatch), superAdminController.patchTenant);
...
router.post('/tenant-provision', requireApprovalAccess(), validate(validateTenantProvision), superAdminController.postTenantProvision);
router.patch('/feature-flags', requireApprovalAccess(), validate(validateFeatureFlagsPatch), superAdminController.patchFeatureFlags);
...
router.patch('/approvals/:id', requireApprovalAccess(), validate(validateApprovalDecision), superAdminController.patchApprovalStatus);
...
router.patch('/scoring-thresholds', requireApprovalAccess(), superAdminController.patchScoringThresholds);
router.get('/escalation-policies', superAdminController.getEscalationPolicies);
router.patch('/escalation-policies', requireApprovalAccess(), superAdminController.patchEscalationPolicies);
router.get('/templates', superAdminController.getTemplates);
router.post('/templates', requireApprovalAccess(), superAdminController.upsertTemplate);
router.get('/localization', superAdminController.getLocalization);
router.patch('/localization', requireApprovalAccess(), superAdminController.patchLocalization);
...
router.patch('/sync-failures/:id', requireApprovalAccess(), validate(validateSyncFailurePatch), superAdminController.patchSyncFailureStatus);
...
router.patch('/support/:id', requireApprovalAccess(), validate(validateSupportTicketPatch), superAdminController.patchSupportTicket);
router.get('/integrations', validate(validateListQuery), superAdminController.listIntegrations);
router.post('/integrations', requireApprovalAccess(), validate(validateIntegrationUpsert), superAdminController.upsertIntegration);
router.get('/releases', validate(validateListQuery), superAdminController.listReleases);
router.post('/releases', requireApprovalAccess(), validate(validateReleaseCreate), superAdminController.createRelease);
router.get('/backups', validate(validateListQuery), superAdminController.listBackups);
router.post('/backups', requireApprovalAccess(), validate(validateBackupCreate), superAdminController.createBackup);
router.get('/policy', superAdminController.getPolicy);
router.patch('/policy', requireApprovalAccess(), superAdminController.patchPolicy);
router.get('/reliability', superAdminController.getReliability);
router.get('/settings', superAdminController.getSettings);
router.patch('/settings', requireApprovalAccess(), superAdminController.patchSettings);
