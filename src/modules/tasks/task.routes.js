...
router.get('/tasks', requirePermissions('task.manage'), taskController.getTasks);
router.post('/tasks', requirePermissions('task.manage'), validate(validateTaskCreate), taskController.postTask);
router.get('/tasks/my', requirePermissions('inspection.create'), taskController.getMyTasks);
