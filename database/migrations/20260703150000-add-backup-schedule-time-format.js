...
module.exports = {
  async up(queryInterface) {
    if (!(await columnExists(queryInterface, 'backup_schedules', 'time_format'))) {
      await queryInterface.addColumn('backup_schedules', 'time_format', {
  ...
  async down(queryInterface) {
    if (await columnExists(queryInterface, 'backup_schedules', 'time_format')) {
      await queryInterface.removeColumn('backup_schedules', 'time_format');
    }
  },
};
